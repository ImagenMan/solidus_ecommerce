# -*- encoding: utf-8 -*-
# stub: solidus_core 3.2.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<actionmailer>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<actionview>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<activejob>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<activemodel>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<activerecord>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_runtime_dependency(%q<railties>.freeze, [">= 5.2", "< 7.1.x"])
    ...
    s.add_dependency(%q<actionmailer>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<actionpack>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<actionview>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<activejob>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<activemodel>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<activerecord>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<activesupport>.freeze, [">= 5.2", "< 7.1.x"])
    s.add_dependency(%q<railties>.freeze, [">= 5.2", "< 7.1.x"])
